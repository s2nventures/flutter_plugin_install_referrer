    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        case (byte) 129: {
          ...
          return value == null ? null : IRInstallationType.values()[(int) value];
        }
        case (byte) 130: {
          Object value = readValue(buffer);
          return value == null ? null : IRInstallationPlatform.values()[(int) value];
        }
        case (byte) 131: {
          Object value = readValue(buffer);
          return value == null ? null : IRPlatform.values()[(int) value];
        }
        case (byte) 132:
